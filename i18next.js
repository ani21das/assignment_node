  ...
  resources: {
    en: {
      translation: {
        ...
        notFoundAllUser: 'Error for finding all user details',
        notFoundUserByLogin: 'Error for finding user details by id',
        phoneAlreadyRegistered: 'Phone number already registered',
        createUserError: 'Error for creating new user',
        phoneNotMatched: 'Given phone number does not matched',
        samePassword: 'Same as previous password',
        userNotFound: 'User not found from database',
        updateUserError: 'Error for updating user details',
        userDeleteDone: 'User deleted successfully',
        userDeleteFailed: 'Error while deleting user details',
